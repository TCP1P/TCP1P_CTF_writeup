## Weak Password
Pada challenge ini kita diberikan zip yang ter lock. Untuk unlocknya kita perlu menggunakan john the ripper.

Pertama kita rubah dari zip ke format john
```sh
zip2john taskweakpassword.zip > hash.txt
```

Setelah itu kita crack menggunakan wordlist seclist
```sh
john -w=/usr/share/wordlists/seclists/Passwords/xato-net-10-million-passwords-1000000.txt hash.txt
```

Bisa kita cek hasilnya menggunakan 
```sh
john --show hash.txt
```
...
output
```
taskweakpassword.zip/taskweakpassword/about.txt:Kaunas:taskweakpassword/about.txt:taskweakpassword.zip::taskweakpassword.zip

1 password hash cracked, 0 left
``` 
Setelah itu kita perlu meng-wrap password itu denga VU{.*}
Flag: VU{Kaunas}

## Eksternal writeup from our team
### Daffainfo
https://github.com/daffainfo/ctf-writeup/tree/main/VU%20CYBERTHON%202023
